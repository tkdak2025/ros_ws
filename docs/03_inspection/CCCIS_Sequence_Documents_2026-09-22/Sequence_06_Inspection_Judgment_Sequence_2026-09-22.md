...
갱신: 2026-09-23. [05 반영 결과](../../작업내역/05_시퀀스_보류항목_반영결과_2026-09-23.md)가 기준이며 기존 PDF는 이전 설계 보존본이다.
...
PASS/FAIL은 판단 완료를 뜻하며 judgment_status=COMPLETED, sequence_status=SUCCESS다. SYSTEM_ERROR는 제품 불량과 구별되는 검사 미완료 결과다. 제품 판정 상태와 Job 종료 가능 여부는 분리하며 #07의 PR #9 완료 조건을 적용한다.
