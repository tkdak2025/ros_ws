...
> 초기 Adaptive Grip 수동 검증 체크리스트의 보존본입니다. 아래 `cable_pkg` 경로와 V02~V09 미확정 항목은 당시 계획입니다. 현행 제어·파지 완료 조건은 [시퀀스 작업내역](<../../시퀀스 작업내역.md>)과 [Adaptive Grip 시퀀스](../../CCCIS_Sequence_Documents_2026-09-22/Sequence_04_Adaptive_Grip_Sequence_2026-09-22.md)를 따릅니다.
