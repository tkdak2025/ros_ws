...
> 초기 컨셉 보존본입니다. 아래의 Connector/Cable 탐색과 Push/Pull 2~3회 반복은 현재 구현된 검사 시퀀스가 아닙니다. 현행 실행 순서와 정책은 [시퀀스 작업내역](<../03_inspection/시퀀스 작업내역.md>) 및 [활성 시퀀스 설계](../03_inspection/CCCIS_Sequence_Documents_2026-09-22/00_DOCUMENT_INDEX.md)를 따릅니다.
