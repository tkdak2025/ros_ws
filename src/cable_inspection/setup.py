...
setup(
    ...
    description="Independent CCCIS robot control and inspection nodes",
    license="Apache-2.0",
    entry_points={"console_scripts": [
        "main_sequence = cable_inspection.sequence.main_node:main",
        "sequence_console = cable_inspection.sequence.sequence_console:main",
        "inspection_judgment = cable_inspection.sequence.judgment_node:main",
        "robot_state_node = cable_inspection.diagnostics.robot_state_node:main",
        "inspection_sequence = cable_inspection.sequence.inspection_cli:main",
