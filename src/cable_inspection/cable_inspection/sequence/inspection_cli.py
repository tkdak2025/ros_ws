...
from cable_inspection.recipe.inspection_recipe import OperatingInspectionRecipe, joint_speed_from_system
from cable_inspection.data_models.models import InspectionResult, JudgmentStatus, SequenceStatus


# 기능: 설치된 cable_inspection의 기본 BMW 레시피 경로를 찾는다.
#
#     ------------------------------------------------------------
#     반환: 기본 레시피 파일의 Path.
