...
하나만 조회한다:
    ...
    선택 컬럼   recipe_version, product_id, point_name, cable_id, cable_type,
                max_displacement_mm, required_pull_force_n, pull_force_limit_n, repeat_count,
                grip_width_mm, point_order
...
class PointInfo:
    ...
    required_pull_force_n: float = 0.0  # 합격 기준 힘 (#06)
    ...
    def load_recipe(self, recipe_id: str) -> RecipeDbInfo:
        ...
        for row in rows:
            ...
            info.points[point_id] = PointInfo(
                ...
                required_pull_force_n=_number(row, keys, 'required_pull_force_n', float),
